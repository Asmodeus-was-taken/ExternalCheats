...
DWORD healthBarColor = D3DCOLOR_ARGB(255, 050, 050, 000);
DWORD Name = D3DCOLOR_ARGB(025, 025, 025, 255);
...
namespace Visuals
{
	...
	void Esp()
	{
		for (int i = 1; i < entities.size(); i++)
		{
			...
			float Health = Offset::Health(Entities.pawn); // Entities Health
			float CurrentHealth = Health / 150.0f;
			...
			if (globals.enableEsp)
			{
                ...
                if(Var.Playboybox)
                {
                    DrawBox(HeadScreen.x - (width / 2) - 1, HeadScreen.y - (height / 5) - 1, width + 2, height + 10, ImColor(255, 255, 255, 255));
                    DrawBox(HeadScreen.x - (width / 2) - 1, HeadScreen.y - (height / 5) - 1, width + 2, height + 8, ImColor(255, 255, 255, 255));
                    DrawBox(HeadScreen.x - (width / 2) - 1, HeadScreen.y - (height / 5) - 1, width + 2, height + 6, ImColor(255, 255, 255, 255));
                    DrawBox(HeadScreen.x - (width / 2) - 1, HeadScreen.y - (height / 5) - 1, width + 2, height + 4, ImColor(255, 255, 255, 255));
                    DrawBox(HeadScreen.x - (width / 2) - 1, HeadScreen.y - (height / 5) - 1, width + 2, height + 2, ImColor(255, 255, 255, 255));
                }
			}
		}
	}
